...
public class JUnitLogParserForPhpUnit {
  ...
  private TestSuites processRoot(File file, SMInputFactory inputFactory) throws XMLStreamException {
  ...
  private TestSuite processTestSuite(SMInputCursor cursor) throws XMLStreamException {
  ...
  private TestCase processTestCase(SMInputCursor cursor) throws XMLStreamException {
